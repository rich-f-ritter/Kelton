...
| **Land use / supply threat** | `analysis/land-use/` | 12,125-parcel 2-mi study + General-Plan/records deep dive. Subject sits in AF's **FrontRunner TOD district**. **Near-term:** for-sale townhomes already delivering next door (Edgewater=D.R. Horton, Meadowbrook=Woodside). **Long-term:** a **~116-ac developer-held TOD land bank** (BACH=Bach Homes 15 ac, Silverado, OCAP AF TOD, AF I-15) — credible but **no site plan filed** and the TOD plan was still **proposed, not adopted** (Aug-2025). Blue Spring / Lehi-PC / Windy City **down-ranked** (Very-Low-Density / wetlands). Workbook + map + `Vacant_Site_Status_Deep_Dive.md`. |
